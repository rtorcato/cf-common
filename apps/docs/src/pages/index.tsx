...
const SIBLINGS = [
	{
		...
		tagline: 'Tree-shakeable TypeScript utilities for everyday Node.js work.',
		href: 'https://rtorcato.github.io/js-common/',
	},
	{
		name: '@rtorcato/browser-common',
		tagline: 'Small, tree-shakeable wrappers around 40+ browser Web APIs.',
		href: 'https://rtorcato.github.io/browser-common/',
	},
	{
		name: '@rtorcato/js-tooling',
		tagline: 'Shared Biome, TypeScript, Vitest and semantic-release presets.',
