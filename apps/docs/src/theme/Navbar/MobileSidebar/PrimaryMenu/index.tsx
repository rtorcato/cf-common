 ...
 *
 * Items are kept in sync with apps/doc/sidebars.ts by hand; the doc sidebar
...
function MenuLink({ item }: { item: Item }): ReactElement {
	...
	const className = [
		'jc-mobile-menu__link',
		isActive && 'jc-mobile-menu__link--active',
		isExternal && 'jc-mobile-menu__external',
	]
		.filter(Boolean)
		.join(' ')
...
export default function NavbarMobilePrimaryMenu(): ReactElement {
	...
	return (
		<ul ref={ref} className="jc-mobile-menu">
			{ITEMS.map((item) => (
